...
import { TsmjhiAlertErrorComponent } from 'app/shared/alert/alert-error.component';
import { MockAlertService } from '../../../helpers/mock-alert.service';

describe('Component Tests', () => {
    describe('Alert Error Component', () => {
        let comp: TsmjhiAlertErrorComponent;
        let fixture: ComponentFixture<TsmjhiAlertErrorComponent>;
        let eventManager: JhiEventManager;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [GatewayTestModule, TranslateModule.forRoot()],
                declarations: [TsmjhiAlertErrorComponent],
                providers: [
                    JhiEventManager,
                    {
                ...
                .overrideTemplate(TsmjhiAlertErrorComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(TsmjhiAlertErrorComponent);
