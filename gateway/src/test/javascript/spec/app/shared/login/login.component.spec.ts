...
import { TsmjhiLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: TsmjhiLoginModalComponent;
        let fixture: ComponentFixture<TsmjhiLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TsmjhiLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(TsmjhiLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(TsmjhiLoginModalComponent);
