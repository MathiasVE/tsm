...
import { TsmjhiHealthCheckComponent } from 'app/admin/health/health.component';
import { TsmjhiHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('TsmjhiHealthCheckComponent', () => {
        let comp: TsmjhiHealthCheckComponent;
        let fixture: ComponentFixture<TsmjhiHealthCheckComponent>;
        let service: TsmjhiHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [GatewayTestModule],
                declarations: [TsmjhiHealthCheckComponent]
            })
                .overrideTemplate(TsmjhiHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(TsmjhiHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(TsmjhiHealthService);
        });
