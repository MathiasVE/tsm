...
import be.mve.tsm.UaaApp;
import be.mve.tsm.config.Constants;
import be.mve.tsm.domain.Authority;
import be.mve.tsm.domain.User;
import be.mve.tsm.repository.AuthorityRepository;
import be.mve.tsm.repository.UserRepository;
import be.mve.tsm.security.AuthoritiesConstants;
import be.mve.tsm.service.MailService;
import be.mve.tsm.service.UserService;
import be.mve.tsm.service.dto.PasswordChangeDTO;
import be.mve.tsm.service.dto.UserDTO;
import be.mve.tsm.web.rest.errors.ExceptionTranslator;
import be.mve.tsm.web.rest.vm.KeyAndPasswordVM;
import be.mve.tsm.web.rest.vm.ManagedUserVM;
