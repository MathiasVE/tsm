...
import be.mve.tsm.config.audit.AuditEventConverter;
import be.mve.tsm.domain.PersistentAuditEvent;
...
import static be.mve.tsm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
